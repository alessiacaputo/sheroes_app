...
(function () {
  ...
  function render(p) {
    ...
    if (step.isRest) {
      ...
      const q = encodeURIComponent(exData.name + " esercizio come si esegue");
      refLink.href = "https://www.youtube.com/results?search_query=" + q;
    }
  ...
  function startWorkout(dayKey) {
    ...
    if (!figure) {
      try {
        ...
        console.error("Omino non disponibile:", e);
        figure = null;
      }
    }
    if (!player) {
